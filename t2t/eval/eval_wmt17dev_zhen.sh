...
cat tmp.bleu.hyp | perl /home/mifs/ech57/tools/mosesdecoder/scripts/ems/support/wrap-xml.perl en /data/mifs_scratch/fs439/exp/t2t/wmt_sgm/references/newsdev2017-zhen-src.zh.sgm UCAM > tmp.bleu.sgm

/data/mifs_scratch/fs439/bin/moses/scripts/generic/mteval-v13a.pl -c -s /data/mifs_scratch/fs439/exp/t2t/wmt_sgm/references/newsdev2017-zhen-src.zh.sgm -r /data/mifs_scratch/fs439/exp/t2t/wmt_sgm/references/newsdev2017-zhen-ref.en.sgm  -t tmp.bleu.sgm -d 3 > tmp.bleu.eval
