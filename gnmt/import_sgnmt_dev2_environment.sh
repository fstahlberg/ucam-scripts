...
export HiFSTROOT=/data/mifs_scratch/fs439/bin/ucam-smt-20161024/
...
export SGNMT=/home/mifs/fs439/bin/sgnmt-dev/
...
export THEANO_FLAGS="on_unused_input='ignore',device=cpu,base_compiledir=/data/mifs_scratch/fs439/sys-tmp/theano_cpu"
