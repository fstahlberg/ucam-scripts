...
qsub -N distribute-on-grid-worker -l h_vmem=60G,mem_free=30G,mem_grab=30G -o $log_dir -e $log_dir -t 1-$num_parts -v total_range=$range,num_parts=$num_parts,cmd_file=$cmd_file $worker_script 
